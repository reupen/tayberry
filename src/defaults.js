...
Tayberry.prototype.defaultOptions = function () {
  return {
    ...
    tooltips: {
      ...
      valueTemplate:
        '<tr><td style="padding-right: 0.5em"><span style="color: {colour}">\u25CF</span> {name}</td><td style="text-align: right">{value}</td></tr>',
...
Tayberry.defaultPrimaryYAxis = Utils.deepAssign({}, [
  Tayberry.defaultYAxis,
  {
    gridLines: {
      colour: '#ccc',
